...
const ResetPassword = (myProp: props) => {
        ...
        try {
            ...
            if (password !== confirmPassword) {
                toast("Passwords do not match!", {
                    containerId: `toastReset-${myProp.employee.id}`,
                    type: "warning"
                })
                return
            }
            ...
            const url = `/employee/${myProp.employee.id}/reset-password`
            const requestData = {
                password
            }

            // hit endpoint to reset employee password
    ...
    return(
        <div>
            <ToastContainer containerId={`toastReset-${myProp.employee.id}`} />
            <button type="button" 
            onClick={() => openModal()}
                ...
                <form onSubmit={e => handleSubmit(e)}>
                    ...
                    <div className="w-full p-3">
                        <div className="my-2 border rounded-md p-3">
                            ...
                            <input type="password" id={`password-${myProp.employee.id}`} 
                            value={password}
                        ...
                        <div className="my-2 border rounded-md p-3">
                            ...
                            <input type="password" id={`confirm-password-${myProp.employee.id}`} 
