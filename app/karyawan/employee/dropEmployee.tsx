...
const DropEmployee = (myProp: props) => {
    ...
    const handleSubmit = async(e: FormEvent) => {
        try {
            ...
            if(response.data.success == true){
                toast(message, {
                    containerId: `toastDrop-${myProp.employee.id}`,
                    type: "success"
                })
                // close modal
                setShow(false)
    ...
    return(
        <div>
            <ToastContainer containerId={`toastDrop-${myProp.employee.id}`} />
            <button type="button" 
            onClick={() => openModal()}
            ...
            <Modal isShow={show}>
                <form onSubmit={e => handleSubmit(e)}>
                    ...
                    <div className="w-full p-3">
                        Apakah Anda yakin ingin menghapus data employee ini?
                    </div>
