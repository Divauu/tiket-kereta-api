...
const FilterHistory = (myProps: props) => {
    ...
    return (
        <div className="py-5 w-full flex flex-wrap items-center rounded-md">
            <div className="w-full md:w-1/2 p-3">
                <strong className="font-semibold text-black">Tanggal Awal</strong>
                <br />
                <input
                    type="date" 
                    id={`departured_time`}
            ...
            <div className="w-full md:w-1/2 p-3">
                <strong className="font-semibold text-black">Tanggal Akhir</strong>
                <br />
                <input
                    type="date"
                    id={`arrived_time`}
            ...
            <button 
                className="bg-blue-600 hover:bg-blue-500 transition-all mx-3 duration-200 text-white px-4 py-2 rounded-md"
